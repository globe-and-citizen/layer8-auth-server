...
func (r *PostgresRepository) GetClientByName(name string) (models.Client, error) {
...
func (r *PostgresRepository) GetClientByBackendURI(backendURI string) (models.Client, error) {
	var client models.Client
...
func (r *PostgresRepository) IsBackendURIExists(backendURL string) (bool, error) {
	var count int64
	if err := r.db.Model(&models.Client{}).Where("backend_uri = ?", backendURL).Count(&count).Error; err != nil {
		return false, err
	}
	return count > 0, nil
}

func (r *PostgresRepository) GetClientByUsername(username string) (models.Client, error) {
	var client models.Client
...
func (r *PostgresRepository) GetClientProfile(username string) (models.Client, error) {
	var client models.Client
	if err := r.db.Where("username = ?", username).First(&client).Error; err != nil {
		return models.Client{}, err
	}
